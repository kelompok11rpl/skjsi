    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<?php
						...
						$tahun=date("Y");
							...
							$query3 = "SELECT max(no_surat) as maxID3 FROM surat where no_surat LIKE '%/UN.16.15.5.2/DL/%'";
							$penomoran3 = mysql_query($query3);
							while ($data3 = mysql_fetch_assoc($penomoran3))
							{
							 $no_surat3 = $data3['maxID3'];							 	
							}
							//echo "$no_surat";
							
							if($no_surat3)
							{
							$nourut3=(int)substr($no_surat3,0,3);
							$nourut3++;
							$baru3='/UN.16.15.5.2/DL/';
							$newid3=sprintf("%03s", $nourut3).$baru3.$tahun;
							//echo "$newid";
							}
							else
							{
               ...
               <form method="post" action="buat_surat_admin.php" <?php echo"$hidden2"; ?> >
				<div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                    <select id="jenis_penomoran">
					  <option value="<?php echo"$newid"; ?>">UN16.15.5.2/PP</option>
					  <option value="<?php echo"$newid3"; ?>">UN.16.15.5.2/DL</option>
					</select>
				...
				<?php
				if(isset($_POST["jenis_penomoran"]))
	{	
