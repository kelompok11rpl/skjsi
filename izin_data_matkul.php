        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
               ...
               <form method="post" action="surat_proses.php" >
				...
				<div class="form-group">
                    <input type="hidden" class="form-control span12" value="srt02" name="id_jenis_surat" id="id_jenis_surat" hidden="hidden" readonly="readonly" required>
                </div>				
                <div class="form-group">
                    <label>Nomor Surat</label>
                    <input type="text" class="form-control span12" value="<?php echo"$newid"; ?>" name="no_surat2" id="no_surat2" readonly="readonly" required>
                </div>
                <div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control span12" name="matkul" id="matkul" required>
                </div>
