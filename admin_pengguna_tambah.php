...
<?php
  ...
  ?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form method="post" action="admin_pengguna_tambah.php">
				<div class="row">
	...
	{
		if($nim&&$nama&&$password&&$password2&&$email&&$status&&$ttl&&$hp&&$hak_akses)
		{
		
		$pass=base64_encode($password);
		$result= mysql_query("insert into user (id_user,nama,password,email,status,ttl,hp,id_hak_akses) VALUES ('$nim','$nama','$pass','$email','$status','$ttl','$hp','$hak_akses')");	  
			...
			if(isset($_POST['nim']))
			{
				if($result >0)
				{
				echo "<div align=center><h5><font color=blue size=6> Data berhasil ditambah</font><h5></div>";
				}
				else
			{
            echo "<div align=center><h5><font color=red size=6> Data gagal ditambah</font><h5></div>";			
			}
			}	
		mysql_close();
		}
	...
	{
	echo "<div align=center><h5><font color=red size=3>Password tidak sama</font><h5></div>";
	}
